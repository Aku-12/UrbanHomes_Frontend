...
import { Mail, KeyRound, Lock, ArrowLeft, Check } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <Link
            to="/login"
            className="mt-6 flex items-center justify-center gap-2 text-gray-600 hover:text-gray-800 text-sm"
          >
            <ArrowLeft size={16} />
            Back to Login
          </Link>
